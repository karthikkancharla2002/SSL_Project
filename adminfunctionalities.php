...
echo <<<_END
<center>
<h2>Existing User deletion</h2>

<div class="container" style="width:800px ;text-align:left">
<form action='adminfunctionalitiesv.php' method='POST'>

<div>
  <label for="userdel" id="user_delete">Please Enter the user name to be deleted: <br></label>
  <input type="text" name="userdel" id="user_delete"/>
  <br>
  <!-- <input type="submit" name="Submit" value="Submit">-->
  <button type="submit" class="btn" name="submit">Submit</button>
</div>
