...
if (mysqli_num_rows($result) == 0 && count($errors) == 0) {
    ...
    echo "<div><br><br><br><br><br><br><br><br><br><br><center><h1><big>Sign-up successful</big></h1></center></div><br>";
    echo "<center><large><a href='loginuserf.php'>Click here to Login!</a></large><center>";
}
else{
